...
with tab2:
    ...
    sql_sa = """
        SELECT nama_satker, FORMAT(SUM(belanja_operasi), 'C', 'id-ID') 'Belanja Operasi', SUM(belanja_modal) AS belanja_modal, SUM(belanja_pengadaan) AS belanja_pengadaan, SUM(total_belanja) AS total_belanja 
        FROM df_rsap 
